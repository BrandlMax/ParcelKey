...
module.exports = class View {
    ...
    updateDisplay(action) {
        ...
        switch (this.STATE) {
            ...
            case 'paketannahme':
                this.paketannahme(action);
                break;

            case 'paketannahmecat':
                this.paketannahmecat(action);
                break;
    ...
    initState(action) {
        ...
        this.UI.writeImg('img/ParcelKey.png');
        // LIGHT
        this.LIGHT.init();
    ...
    changeTimeState(action) {
        ...
        if (this.needContiAction) {
            ...
            this.UI.writeImg('img/check.png');
        }
    ...
    bestellung(action) {
        if (!this.ordered) {
            this.LIGHT.init();
            this.UI.writeImg('img/order.png');
        } else {
            this.LIGHT.ok();
            this.UI.writeImg('img/check.png');
        }
    ...
    kontaktanfrage(action) {
        ...
        if (!this.accepted) {
            this.UI.writeImg('img/contact.png');
            this.LIGHT.problem();
        } else {
            this.UI.writeImg('img/check.png');
            this.LIGHT.ok();
    ...
    paketannahmecat(action) {
        this.UI.writeImg('img/cat.png');
        setTimeout(() => {
            this.STATE = 'statusState';
            this.ordered = false;
        }, 10000)
